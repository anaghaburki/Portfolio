...
function ButtonWithImage({ icon, activeIcon, label, imageStyle = "" }) {
  ...
  return (
    <div
      className="border-2 border-[#005e23] text-white py-3 px-5 rounded-md flex items-center justify-center gap-2 hover:bg-[#37BCF8] hover:text-black hover:font-semibold"
      onMouseEnter={() => {
