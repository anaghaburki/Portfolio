...
function Card({ name, img, description, link }) {
  return (
    <div className="w-full shadow-lg bg-[#003300] p-4 rounded-lg flex flex-col items-center h-[500px]">
      <div className="h-110 overflow-hidden flex flex-col items-center justify-start">
        ...
        <div className="text-lg font-semibold pb-2 text-white">{name}</div>
