...
function Contact() {
  return (
    <div className="md:w-10/12 w-11/12 mx-auto text-white py-14 pb-24" id="contact">
      <div className="font-bold text-xl text-[#005e23] pb-6">{contact}</div>
      <div className="sm:w-3/4 w-10/12 mx-auto shadow-lg rounded-lg">
        <div className="bg-[#003300] rounded-lg py-6 px-4 flex flex-wrap items-center sm:justify-center gap-6">
